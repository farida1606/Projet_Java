...
public class Controller {
   ...
   /* final URL fxmlURL = getClass().getResource("monFXML.fxml");  
    ...
    final Controller controler = fxmlLoader.getController();*/

    @FXML
    JFXComboBox comboFormatIns;

    @FXML
    AnchorPane fichierPane, afficherPane, insererPane, articlePane, photoPane, rechercherPane, supprimerPane;

    @FXML
    JFXTextField txtNomBase, txtCheminSauvegarde, txtCheminOuvrir, txtAuteurArtIns, txtTitreArtIns, txtUrlArtIns, txtSourceArtIns, txtTitrePhIns, txtAuteurPhIns, txtSourcePhIns, txtResolPhIns, txtMotsCles;

    @FXML
    JFXTextArea txtTexteIns;

    @FXML
    JFXRadioButton radioAtricleIns, radioPhotoIns,radioNbPhIns, radioCouleurPhIns;

    @FXML
    JFXCheckBox checkElecIns, checkPapierIns;

    @FXML
    JFXDatePicker dateArtIns, datePhIns;
